                    ...
                    <tr class="align-middle {{ $jb->ditolak ? 'rejected' : '' }}">
                      ...
                      <td>
                        @if ($jb->umpan_balik)
                          {{ $jb->umpan_balik }}
                        @else
                          <a href="{{ route('dosen.umpan-balik', ['id' => $jb->id]) }}" type="button" class="btn btn-info mx-auto d-block {{ !$jb->diterima || $jb->ditolak ? 'disable_a_href' : '' }}">Umpan Balik</a>
                        @endif
                      </td>
                      @if ($jb->diterima)
                      ...
                      @else
                        <td>
                          <a href="{{ route('dosen.bimbingan-acc', ['id' => $jb->id]) }}" type="button" class="btn btn-danger mx-auto d-block {{ $jb->ditolak ? 'disable_a_href' : '' }}">Belum</a>
                        </td>
                      @endif
                    </tr>
                  @endforeach
