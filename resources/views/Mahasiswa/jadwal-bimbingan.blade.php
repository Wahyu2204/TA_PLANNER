...
@section('content')
    <x-header-content-dashboard head="Jadwal Bimbingan" />
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div id="calendar" style="widows: 80%">
                                <button type="button" class="btn btn-success mx-auto d-block mt-4" style="padding: 8px 30px">Pilih Jadwal</button>
                            </div>
                        </div>
                    </div>
                </div>
